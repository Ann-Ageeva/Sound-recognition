...
3. **Описание вариантов выполнения отладочной версии алгоритма**
4. **Описание вариантов выполнения рабочей версии алгоритма**
5. **Текст алгоритма**
...
Разработанный алгоритм служит для определения местоположения дрона посредством нахождения угла в градусах относительно центра оси, образованного двумя микрофонами.
### 1.2 Входные данные
Входные данные для алгоритма поступают в виде монофонических аудиофайлов с двух микрофонов в формате wav.
### 1.3 Выходные данные
Выходные данные алгоритма представляют собой рассчитанный угол, зависящий от расстояния между микрофонами, в градусном измерении от 0 до 180.
## 2. Описание модулей и процедур
...
Дополнительно была использована библиотека Librosa для преобразования аудиофайлов из формата wav в numpyArray.
## 3. Описание вариантов выполнения отладочной версии алгоритма
Для работы алгоритма необходимо наличие двух аудиофайлов в формате wav, путь к ним необходимо указать в соответствующих переменных (pathFirstMicro, pathSecondMicro). Для корректной работы алгоритма необходимо скорректировать переменные dist (расстояние между микрофонами) и frequency (частота дискретизации).
## 4. Описания вариантов выполнения рабочей версии алгоритма
